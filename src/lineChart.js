...
export class LineChart {
    ...
    updateTime(data, years) {
        for (let i = 0; i < data.length; i++) // iterate on chart , temp and co2
        {
            ...
            this.charts[i].options.scales.xAxes[0].ticks.min = years[0];
            this.charts[i].options.scales.xAxes[0].ticks.max = years[2];
